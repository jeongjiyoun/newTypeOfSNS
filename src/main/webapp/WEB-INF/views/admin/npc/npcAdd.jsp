	...
	<tbody>
		<tr>
			<td rowspan="6" class="ranking" scope="row" style="height: 200px; padding:10px;">
				<div id='View_area' style='width: 180px; height: 200px; min-height:165px; margin-bottom: 5px; color: black; border: 0px solid black; dispaly: inline; '></div>
			...
			<td rowspan="1" ><input type="text" name="name" style="width:96%; height: 25px; padding-top:2px; border: none;"></td>
		</tr>
		<tr>
		</tr>
		<tr>
			<td rowspan="2"><strong>설명</strong></td>
			<td rowspan="2"><textarea name="comment" rows="1" cols="1" style="width: 96%; height: 200px; border: none; overflow:none;"></textarea></td>
		</tr>
	</tbody>
	<tfoot>
	<tr>
